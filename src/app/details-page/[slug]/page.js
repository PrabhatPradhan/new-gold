    ...
    <p className="text-xs text-yellow-600 ">* GST & TCS Extra</p>
            ...
            <div className="mt-2 bg-white p-4 rounded-2xl shadow-xl max-w-xl mx-auto">
              ...
              <form className="space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:from-green-600 hover:to-green-700 transform hover:scale-105 transition-all duration-300 ease-in-out"
                >
                  Submit Inquiry Form
                </button>
              </form>
